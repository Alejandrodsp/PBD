...
<h1>
<center>
<font color="WHITE">ADICIONAR LUCRO</font>
<br/><br/>
...
<h3>
<center>
<form name ="createanuncio" method = "post" action = "resultlucro.php">
<input type="text" name="Data_lucro"placeholder="Insira a data" /><br /><br/>
